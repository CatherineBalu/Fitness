    ...
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-left-4 duration-300">
      ...
      <div className="flex flex-col gap-3">
        <Button
          variant="outline"
          type="button"
          className="w-full bg-transparent border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-white flex items-center justify-center"
        >
        ...
        <Button
          ...
          className="w-full bg-transparent border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-white flex items-center justify-center"
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5 mr-2" fill="#1877F2">
...
function Register({ onSwitchToLogin }: { onSwitchToLogin: () => void }) {
  ...
  return (
    <form
      ...
      className="flex flex-col gap-4 animate-in fade-in slide-in-from-right-8 duration-300"
    >
    ...
    >
      ...
      <DialogContent className="sm:max-w-[425px] bg-slate-950 text-slate-100 border-slate-800 shadow-2xl overflow-hidden">
        ...
        <DialogHeader className="relative">
          ...
          <DialogTitle
            className={`text-xl font-bold text-white ${view === 'register' ? 'pl-8' : ''}`}
          >
            {view === 'login' ? 'Gym Access' : 'Create an Account'}
          </DialogTitle>
          <DialogDescription
            className={`text-slate-400 ${view === 'register' ? 'pl-8' : ''}`}
          >
            {view === 'login'
