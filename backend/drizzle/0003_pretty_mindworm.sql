...
ALTER TABLE "TB_customer_reservation" ADD CONSTRAINT "TB_customer_reservation_ID_customer_fk_ID_schedule_fk_pk" PRIMARY KEY("ID_customer_fk","ID_schedule_fk");--> statement-breakpoint
ALTER TABLE "TB_customer_reservation" ADD COLUMN "attended" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "TB_customer_reservation" ADD COLUMN "reservationDate" timestamp DEFAULT now() NOT NULL;--> statement-breakpoint
...
ALTER TABLE "TB_schedule" ADD COLUMN "for_members" boolean DEFAULT false NOT NULL;--> statement-breakpoint
...
ALTER TABLE "TB_customer_reservation" DROP COLUMN "ID_reservation";--> statement-breakpoint
ALTER TABLE "TB_customer_reservation" DROP COLUMN "reservation_date";--> statement-breakpoint
